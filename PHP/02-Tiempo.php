...
<body>
    <h1>02-Tiempo.php</h1>
    <p>Comprobar que el resultado del interprete cambia de una a otra ejecución. Se utiliza la función time() para comprobar que el resultado varía en el tiempo.</p>
